...
"""
    if not filename:
        filename = os.path.join(
            os.path.dirname(__file__), 'chatbotQuery', 'version.py')
...
def write_versionfile():
    ...
    text = '''"""
Version information for chatbotQuery, created during installation by
setup.py.
...
description = """Python package for easy construction of a functional chatbot
with query database purposes."""
long_description = """
"""
...
keywords = ['math', 'artificial intelligence', 'Finite state machine', 'framework']
